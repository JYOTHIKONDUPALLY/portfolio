...
<ToggleGroup>
    ...
    <Divider/>
    {toggle==="frontend"?(
        <ToggleButton active onClick={()=>setToggle("frontend")}>Frontend</ToggleButton>
    ):(<ToggleButton onClick={()=>setToggle("frontend")}>Frontend</ToggleButton>)}
    <Divider/>
    {toggle==="backend"?(
        <ToggleButton active onClick={()=>setToggle("backend")} >Backend</ToggleButton>
    ):(
        <ToggleButton  onClick={()=>setToggle("backend")}>Backend</ToggleButton>)}
    <Divider/>
    {toggle==="fullStack"?(
        <ToggleButton active onClick={()=>setToggle("fullStack")}>Full Stack</ToggleButton>
    ):(<ToggleButton onClick={()=>setToggle("fullStack")}>Full Stack</ToggleButton>)}
</ToggleGroup>
<ProjectsContainer>
